...
const ExploreCard = ({ id, imgUrl, title, index, active, handleClick }) => (
  ...
  >
    ...
    />
    {active !== id ? (
      <h3 className="font-semibold text-white text-[18px] sm:text-[24px] absolute z-0 lg:bottom-20 lg:rotate-[-90deg] lg:origin[0,0]">
        {title}
      </h3>
    ) : (
      <div className="absolute bottom-0 p-8 justify-center w-full flex-col bg-[rgba(0,0,0,0.5)] rounded-b-[24px]">
        <div
